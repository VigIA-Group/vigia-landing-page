        ...
        <div className="mb-14">
          ...
          <div className="relative ml-7">
            <select
              ...
              onChange={(e) => setDefaultHorario(e.target.value as HorarioType)}
        ...
        <div className="space-y-12">
          <div className="mb-2 border-b border-text/10 pb-6">
            ...
            <p className="text-base text-muted font-normal leading-relaxed">
              Añade las cámaras que tienes en tu negocio. Puedes personalizar el
              nivel de vigilancia y los comportamientos a detectar de forma
              individual según el área (ej. Entrada principal, Almacén, Cajas).
            </p>
          </div>
          ...
          <div className="w-full space-y-3.5 pt-6 mt-1 border-t border-background/15 text-[13px]">
            ...
            {totals.totalDescVolUsd > 0 ? (
              <div className="flex justify-between items-center text-primary-dark font-semibold text-sm">
                <span>
                  Descuento por Volumen (-{totals.descVolPercent * 100}%)
                </span>
            ...
            {totals.totalDescHorUsd > 0 && (
              <div className="flex justify-between items-center text-primary-dark font-semibold text-sm">
                <span>Descuento por Horarios (Acumulado)</span>
                <span className="font-mono">
